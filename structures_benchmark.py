...
def do_benchmark(benchmark_name, file_path):
    ...
    zipped_json_path = results_path.joinpath("zipped_json.7z")
    zipped_raw_bson_path = results_path.joinpath("zipped_raw_bson.7z")
    zipped_bson_with_only_values_path = results_path.joinpath("zipped_bson_with_only_values.7z")
    zipped_struct_path = results_path.joinpath("zipped_struct.7z")
